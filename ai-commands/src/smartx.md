---
description: Generate or migrate Smart X metadata-driven routines - model, interface, and launcher TLPP sources
argument_hint: "[--mode generate|migrate] [--output path]"
---

...
Desde a v1.5.0, o conhecimento do plugin tambem funciona fora do Claude Code: as 18 skills sao instalaveis no **GitHub Copilot, Cursor, Gemini CLI, Codex** e mais de 70 agentes com um unico comando (`npx skills add thalysjuvenal/advpl-specialist`). Veja [Outras IAs](/docs/outras-ias).
...
|---------|------------|-----------|
| **Comandos** | 14 | Invocaveis diretamente no Claude Code |
| **Agentes** | 10 | Especializados em tarefas especificas |
| **Skills** | 18 | Bases de conhecimento com templates, regras e referencia |
...
Use as mesmas 18 skills no GitHub Copilot, Cursor, Gemini CLI, Codex e outros agentes, com templates de instrucoes (`AGENTS.md`, `copilot-instructions.md`) e os 14 comandos compilados para `.github/prompts/`, `.cursor/commands/` e `.gemini/commands/`. Detalhes em [Outras IAs](/docs/outras-ias).

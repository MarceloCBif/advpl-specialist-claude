# /document — Generate technical documentation from ADVPL/TLPP source code, including Protheus.doc headers and API docs
...
- Match the language of the source code's existing comments and docblocks (Protheus projects typically use Brazilian Portuguese).
